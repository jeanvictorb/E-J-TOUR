...
var NgbAccordion = class _NgbAccordion {
  ...
  ngAfterContentChecked() {
    ...
    this._ngZone.onStable.pipe((0, import_operators3.take)(1)).subscribe(() => {
      this.panels.forEach((panel) => {
    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_0 = goog.getMsg("Close");
          i18n_0 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_0;
        } else {
...
var NgbCarousel = class _NgbCarousel {
  ...
  constructor(config, _platformId, _ngZone, _cd, _container) {
    ...
    this._interval$ = new import_rxjs3.BehaviorSubject(0);
    this._mouseHover$ = new import_rxjs3.BehaviorSubject(false);
    this._focused$ = new import_rxjs3.BehaviorSubject(false);
    this._pauseOnHover$ = new import_rxjs3.BehaviorSubject(false);
    this._pauseOnFocus$ = new import_rxjs3.BehaviorSubject(false);
    this._pause$ = new import_rxjs3.BehaviorSubject(false);
    this._wrap$ = new import_rxjs3.BehaviorSubject(false);
  ...
  ngAfterContentInit() {
    if (isPlatformBrowser(this._platformId)) {
      this._ngZone.runOutsideAngular(() => {
        ...
        (0, import_rxjs3.combineLatest)([this._pause$, this._pauseOnHover$, this._mouseHover$, this._pauseOnFocus$, this._focused$, this._interval$, hasNextSlide$]).pipe((0, import_operators3.map)(([pause, pauseOnHover, mouseHover, pauseOnFocus, focused, interval, hasNextSlide]) => pause || pauseOnHover && mouseHover || pauseOnFocus && focused || !hasNextSlide ? 0 : interval), (0, import_operators3.distinctUntilChanged)(), (0, import_operators3.switchMap)((interval) => interval > 0 ? (0, import_rxjs3.timer)(interval, interval) : import_rxjs3.NEVER), (0, import_operators3.takeUntil)(this._destroy$)).subscribe(() => this._ngZone.run(() => this.next(NgbSlideEventSource.TIMER)));
      });
    }
    this.slides.changes.pipe((0, import_operators3.takeUntil)(this._destroy$)).subscribe(() => {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_1 = goog.getMsg(" Slide {$interpolation} of {$interpolation_1} ", {
            "interpolation": "�0�",
            "interpolation_1": "�1�"
          }, {
            original_code: {
          ...
          i18n_1 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_1;
        } else {
        ...
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_2 = goog.getMsg("Previous");
          i18n_2 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_2;
        } else {
          i18n_2 = $localize`:@@ngb.carousel.previous:Previous`;
        }
        let i18n_3;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_3 = goog.getMsg("Next");
          i18n_3 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_3;
        } else {
...
var NgbDatepicker = class _NgbDatepicker {
  constructor(_service, _calendar, _i18n, config, cd, _elementRef, _ngbDateAdapter, _ngZone) {
    ...
    this._destroyed$ = new import_rxjs3.Subject();
    this._publicState = {};
    this.navigate = new EventEmitter();
    ...
    _service.dateSelect$.pipe((0, import_operators3.takeUntil)(this._destroyed$)).subscribe((date) => {
      this.dateSelect.emit(date);
    });
    _service.model$.pipe((0, import_operators3.takeUntil)(this._destroyed$)).subscribe((model) => {
  ...
  focus() {
    this._ngZone.onStable.asObservable().pipe((0, import_operators3.take)(1)).subscribe(() => {
  ...
  ngAfterViewInit() {
    this._ngZone.runOutsideAngular(() => {
      ...
      }), (0, import_operators3.takeUntil)(this._destroyed$)).subscribe(({
        type
  ...
  if (type) {
    zone.runOutsideAngular(wrapAsyncForMobile(() => {
      ...
      const escapes$ = (0, import_rxjs3.fromEvent)(document2, "keydown").pipe(
        ...
        (0, import_operators3.filter)((e) => e.which === Key.Escape),
...
var ngbFocusTrap = (zone, element, stopFocusTrap$, refocusOnClick = false) => {
  zone.runOutsideAngular(() => {
    ...
    (0, import_rxjs3.fromEvent)(element, "keydown").pipe(
      (0, import_operators3.takeUntil)(stopFocusTrap$),
      /* eslint-disable-next-line deprecation/deprecation */
      (0, import_operators3.filter)((e) => e.which === Key.Tab),
...
var PopupService = class {
  ...
  open(content, templateContext, animation = false) {
    ...
    const transition$ = this._ngZone.onStable.pipe((0, import_operators3.take)(1), (0, import_operators3.mergeMap)(() => ngbRunTransition(this._ngZone, nativeElement, ({
      classList
    }) => classList.add("show"), {
      animation,
      runningTransition: "continue"
...
var NgbModalBackdrop = class _NgbModalBackdrop {
  ...
  ngOnInit() {
    this._zone.onStable.asObservable().pipe((0, import_operators3.take)(1)).subscribe(() => {
...
var NgbModalWindow = class _NgbModalWindow {
  ...
  _enableEventHandling() {
    ...
    this._zone.runOutsideAngular(() => {
      (0, import_rxjs3.fromEvent)(nativeElement, "keydown").pipe(
...
var NgbNav = class _NgbNav {
  ...
  ngAfterContentInit() {
    ...
    this.items.changes.pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe(() => this._notifyItemChanged(this.activeId));
  }
  ngOnChanges({
    activeId
  }) {
...
var NgbNavOutlet = class _NgbNavOutlet {
  ...
  ngAfterViewInit() {
    ...
    this.nav.navItemChange$.pipe((0, import_operators3.takeUntil)(this.nav.destroy$), (0, import_operators3.startWith)(this._activePane?.item || null), (0, import_operators3.distinctUntilChanged)(), (0, import_operators3.skip)(1)).subscribe((nextItem) => {
      const options = {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        let i18n_12;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_12 = goog.getMsg("««");
          i18n_12 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_12;
        } else {
          i18n_12 = $localize`:@@ngb.pagination.first:««`;
        }
        let i18n_13;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_13 = goog.getMsg("«");
          i18n_13 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_13;
        } else {
          i18n_13 = $localize`:@@ngb.pagination.previous:«`;
        }
        let i18n_14;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_14 = goog.getMsg("»");
          i18n_14 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_14;
        } else {
          i18n_14 = $localize`:@@ngb.pagination.next:»`;
        }
        let i18n_15;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_15 = goog.getMsg("»»");
          i18n_15 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_15;
        } else {
          i18n_15 = $localize`:@@ngb.pagination.last:»»`;
        }
        let i18n_16;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_16 = goog.getMsg("First");
          i18n_16 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_16;
        } else {
          i18n_16 = $localize`:@@ngb.pagination.first-aria:First`;
        }
        let i18n_17;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_17 = goog.getMsg("Previous");
          i18n_17 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_17;
        } else {
          i18n_17 = $localize`:@@ngb.pagination.previous-aria:Previous`;
        }
        let i18n_18;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_18 = goog.getMsg("Next");
          i18n_18 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_18;
        } else {
          i18n_18 = $localize`:@@ngb.pagination.next-aria:Next`;
        }
        let i18n_19;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_19 = goog.getMsg("Last");
          i18n_19 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_19;
        } else {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        let i18n_20;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_20 = goog.getMsg("{$interpolation}", {
            "interpolation": "�0�"
          }, {
            original_code: {
          ...
          i18n_20 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_20;
        } else {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        let i18n_21;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_21 = goog.getMsg("HH");
          i18n_21 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_21;
        } else {
          i18n_21 = $localize`:@@ngb.timepicker.HH:HH`;
        }
        let i18n_22;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_22 = goog.getMsg("Hours");
          i18n_22 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_22;
        } else {
          i18n_22 = $localize`:@@ngb.timepicker.hours:Hours`;
        }
        let i18n_23;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_23 = goog.getMsg("MM");
          i18n_23 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_23;
        } else {
          i18n_23 = $localize`:@@ngb.timepicker.MM:MM`;
        }
        let i18n_24;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_24 = goog.getMsg("Minutes");
          i18n_24 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_24;
        } else {
          i18n_24 = $localize`:@@ngb.timepicker.minutes:Minutes`;
        }
        let i18n_25;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_25 = goog.getMsg("Increment hours");
          i18n_25 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_25;
        } else {
          i18n_25 = $localize`:@@ngb.timepicker.increment-hours:Increment hours`;
        }
        let i18n_26;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_26 = goog.getMsg("Decrement hours");
          i18n_26 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_26;
        } else {
          i18n_26 = $localize`:@@ngb.timepicker.decrement-hours:Decrement hours`;
        }
        let i18n_27;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_27 = goog.getMsg("Increment minutes");
          i18n_27 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_27;
        } else {
          i18n_27 = $localize`:@@ngb.timepicker.increment-minutes:Increment minutes`;
        }
        let i18n_28;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_28 = goog.getMsg("Decrement minutes");
          i18n_28 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_28;
        } else {
          i18n_28 = $localize`:@@ngb.timepicker.decrement-minutes:Decrement minutes`;
        }
        let i18n_29;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_29 = goog.getMsg("SS");
          i18n_29 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_29;
        } else {
          i18n_29 = $localize`:@@ngb.timepicker.SS:SS`;
        }
        let i18n_30;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_30 = goog.getMsg("Seconds");
          i18n_30 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_30;
        } else {
          i18n_30 = $localize`:@@ngb.timepicker.seconds:Seconds`;
        }
        let i18n_31;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_31 = goog.getMsg("Increment seconds");
          i18n_31 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_31;
        } else {
          i18n_31 = $localize`:@@ngb.timepicker.increment-seconds:Increment seconds`;
        }
        let i18n_32;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_32 = goog.getMsg("Decrement seconds");
          i18n_32 = MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_32;
        } else {
          i18n_32 = $localize`:@@ngb.timepicker.decrement-seconds:Decrement seconds`;
        }
        let i18n_33;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_WINDOWS_DOCUMENTS_GITHUB_E_J_TOUR_E_J_TOUR_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_MJS_33 = goog.getMsg("{$interpolation}", {
            "interpolation": "�0�"
          }, {
            original_code: {
...
var NgbTypeahead = class _NgbTypeahead {
  constructor(_elementRef, viewContainerRef, _renderer, injector, config, ngZone, _live, _document, _ngZone, _changeDetector, applicationRef) {
    ...
    this.placement = config.placement;
    this.popperOptions = config.popperOptions;
    this._valueChanges = (0, import_rxjs3.fromEvent)(_elementRef.nativeElement, "input").pipe((0, import_operators3.map)(($event) => $event.target.value));
